							...
							<div className="col-lg-8 offset-lg-2">
								<div className="content">
									<p className="title font-main-2 text-anime-wave">
										Otelinizi Büyütmek İçin
										<span> Doğru Adımı Atın </span>
									</p>
									<p className="text">
										Yatırımdan yönetime, marka entegrasyonundan gelir optimizasyonuna kadar
										otelcilik sektörünün her alanında sahadan gelen <br /> deneyimle yanınızdayız.
									</p>
									<Link href="/contact" className="tf-btn text-anime-style-1">Danışmanlık Alın <i className="icon-chevron-right" /></Link>
								</div>
							</div>
						</div>
					</div>
