...
const serviceCategories = [
  ...
  },
  {
    ...
    titleTr: 'Otelinizi Geliştirme Planı (HIP)',
    titleEn: 'HIP - Hotel Improvement Plan',
    titleAr: 'HIP - خطة تحسين الفندق',
    titleRu: 'HIP - План улучшения отеля',
    descTr: 'Otelinizi Geliştirme Planı (HIP), otelinizin performansını KPI bazlı analiz ederek gelir, operasyon ve maliyet tarafında ölçülebilir iyileştirme sunan dönüşüm programımızdır.',
