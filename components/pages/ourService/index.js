...
const serviceCategories = [
  ...
  },
  {
    id: 'broker',
    icon: 'flaticon-building',
    image: '/images/section/service-yatirim.jpg',
    ...
    descEn: 'Establishing a critical bridge between investors and hotel owners in the hospitality sector. We provide expert brokerage services in hotel sales, leases and management transfers.',
    items: [
      { titleTr: 'Otel Satış Aracılığı', titleEn: 'Hotel Sales Brokerage', descTr: 'Doğru alıcı ve satıcıyı buluşturarak mülkün gerçek değerinde el değiştirmesini sağlarız. Piyasa fiyatını ve doğru zamanlamayı belirleyerek taraflar için optimum sonucu garanti ediyoruz.', descEn: 'Matching the right buyers and sellers to ensure property changes hands at its true value. We identify market pricing and optimal timing to guarantee the best outcome for all parties.' },
      { titleTr: 'Kiralama & İşletme Devri', titleEn: 'Lease & Management Transfer', descTr: 'Kiralama ve işletme haklarının devri süreçlerinde hukuki ve stratejik danışmanlık. Sözleşme yapılarını, finansal koşulları ve operasyonel geçiş planlarını yönetiyoruz.', descEn: 'Legal and strategic consulting during the transfer of leasing and management rights. We manage contract structures, financial terms and operational transition plans.' },
